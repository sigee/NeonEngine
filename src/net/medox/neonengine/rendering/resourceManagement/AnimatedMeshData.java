...
//	private Vector3f maxVertex;
	...
	public AnimatedMeshData(IndexedModel model){
		super();
...
//		RenderingEngine.meshBound = vertexArrayObject;
		...
		final Vector3f[] vertexData6 = new Vector3f[model.getTangents().size()];//TODO add this
		model.getTangents().toArray(vertexData6);//TODO add this
